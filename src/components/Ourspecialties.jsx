  ...
  return (
    <div>
        ...
        <Container className='containerxxxl mt-5'>
            <Row>
                <Col xs={12} lg={6} className='text-xxl-end'>
                    <p className='ff_Anybody fw_700 fsize_48 clr_dark_green '>Our Specialties</p>
                </Col>
                <Col xs={12} lg={6}>
                    <p className='ff_Read_Hat_text fw_400 fsize_22 clr_light_gray px-xxl-5 w_492 '>Duis aute irure dolor in reprehenderit in voluptate cillum dolore eu fugiat nulla pariatur.</p>
                </Col>
            </Row>
            <Row className='pt-5 mt-3'>
                <Col lg={4}>
                    <div className='Our_Specialties_box d-flex gap-5 h-100 '>
                        ...
                        <div>
                            <p className='ff_Anybody fw_700 fsize_22 clr_almost_black m b-2'>Easy to order</p>
